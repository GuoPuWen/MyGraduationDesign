package com.example.myimage.swt;
...
public class StrokeWidthTransform {
    ...
    public StrokeWidthTransform(Bitmap bitmap){
        this.bitmap = bitmap;
    }
    ...
    public Bitmap swt(){
        ...
        Mat gary = new Mat();
        Imgproc.cvtColor(src, gary, Imgproc.COLOR_BGR2RGB);
        Bitmap res = Bitmap.createBitmap(src.width(), src.height(), Bitmap.Config.ARGB_8888);
        return res;
